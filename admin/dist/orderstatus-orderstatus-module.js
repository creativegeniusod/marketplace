...
/***/ "./src/theme/default/admin/settings/components/localizations/orderstatus/add/add.component.html":
/*!******************************************************************************************************!*\
  !*** ./src/theme/default/admin/settings/components/localizations/orderstatus/add/add.component.html ***!
  \******************************************************************************************************/
...
module.exports = "<div class=\"flex setting2-inner-header\">\n    <h3 style=\"color:#FF006A\">{{updatetitle ? 'Update Order Status' : 'Add Order Status'}}</h3>\n</div>\n<div class=\"settings-right-wrapper addnewuser\">\n\n    <div class=\"new-user\">\n        <form (ngSubmit)=\"onSubmit()\" [formGroup]=\"orderstatusform\" class=\"form-horizontal m-t-20\">\n            <div class=\"row\">\n                <div class=\"col-lg-6 col-xs-12\">\n                    <div class=\"form-group\">\n                        <label>Order Status Name<sup class=\"supvalidation\">*</sup></label>\n                        <input type=\"text\" formControlName=\"orderstatusName\" class=\"form-control\" placeholder=\"Order Status Name\" [ngClass]=\"{ 'is-invalid': submitted && f.orderstatusName.errors }\" />\n                        <div *ngIf=\"submitted && f.orderstatusName.errors\" class=\"invalid-feedback\">\n                            <div *ngIf=\"f.orderstatusName.errors.required\">\n                                Order Status Name is required\n                            </div>\n                        </div>\n                    </div>\n                </div>\n\n                <div class=\"col-lg-6 col-xs-12\">\n                    <div class=\"form-group\">\n                        <label class=\"control-label\">Status\n                            <sup class=\"supvalidation\">*</sup></label>\n                        <select class=\"form-control custom-select\" formControlName=\"status\" data-placeholder=\"Choose Role\" [ngClass]=\"{ 'is-invalid': submitted && f.status.errors }\" [ngClass]=\"{ 'invalid': submitted}\" placeholder=\"status\">\n                            <option value=''>- -Select Status- -</option>\n                            <option value=\"1\">Enabled</option>\n                            <option value=\"0\">Disabled</option>\n                        </select>\n                        <div *ngIf=\"submitted && f.status.errors\" class=\"invalid-feedback\">\n                            <div *ngIf=\"f.status.errors.required\">\n                                Order Status is required\n                            </div>\n                        </div>\n                    </div>\n                </div>\n\n                <div class=\"col-lg-6 col-xs-12\">\n                    <div class=\"form-group\">\n                        <label class=\"control-label\">Color Code</label><br>\n                        <input [(ngModel)]=\"colorcode\" [ngClass]=\"{'invalid': colorRequire}\" [(colorPicker)]=\"color\" formControlName=\"colorcode\" (colorPickerChange)=\"onchange($event)\" [value]=\"color\" />\n\n                    </div>\n                    <div *ngIf=\"colorRequire\" style=\"color: #f62d51\">\n                        Order Status Color is required\n                    </div>\n                </div>\n\n                <div class=\"col-12\">\n                    <div class=\"flex user-btn\">\n                        <button type=\"submit\" class=\"btn btn-add\">Save\n                        </button>\n                        <button (click)=\"Addordstatuscancel()\" class=\"btn btn-cancel\"> Cancel\n                        </button>\n                    </div>\n                </div>\n            </div>\n        </form>\n    </div>\n</div>"

/***/ }),

/***/ "./src/theme/default/admin/settings/components/localizations/orderstatus/add/add.component.ts":
/*!****************************************************************************************************!*\
  !*** ./src/theme/default/admin/settings/components/localizations/orderstatus/add/add.component.ts ***!
  \****************************************************************************************************/
/*! exports provided: OrderStatusAddComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrderStatusAddComponent", function() { return OrderStatusAddComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _core_admin_settings_localizations_orderstatus_orderstatus_sandbox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../../../../core/admin/settings/localizations/orderstatus/orderstatus.sandbox */ "./src/core/admin/settings/localizations/orderstatus/orderstatus.sandbox.ts");
/* harmony import */ var _core_admin_settings_localizations_orderstatus_orderstatus_ApiClientService__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../../../../core/admin/settings/localizations/orderstatus/orderstatus-ApiClientService */ "./src/core/admin/settings/localizations/orderstatus/orderstatus-ApiClientService.ts");
...
var OrderStatusAddComponent = /** @class */ (function () {
    function OrderStatusAddComponent(fb, route, appSandbox, router, service) {
        this.fb = fb;
        this.route = route;
    ...
    OrderStatusAddComponent.prototype.beforeChange = function ($event) {
    ...
    OrderStatusAddComponent.prototype.ngOnInit = function () {
    ...
    // reactive form
    OrderStatusAddComponent.prototype.initForm = function () {
        this.orderstatusName = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]);
        ...
        this.colorcode = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]);
    ...
    OrderStatusAddComponent.prototype.Addordstatuscancel = function () {
     ...
     */
    OrderStatusAddComponent.prototype.onSubmit = function () {
        this.submitted = true;
    ...
    OrderStatusAddComponent.prototype.editOrderStatusList = function () {
        ...
        if (this.orderstatusinfo[0] !== null) {
            if (this.orderstatusinfo[0] && this.orderstatusinfo[0].name) {
                this.updatetitle = 1;
                this.orderstatusform.controls['orderstatusName'].setValue(this.orderstatusinfo[0].name);
                this.orderstatusform.controls['status'].setValue(this.orderstatusinfo[0].isActive);
    ...
    Object.defineProperty(OrderStatusAddComponent.prototype, "f", {
        // Validation Function
        get: function () {
    ...
    //
    OrderStatusAddComponent.prototype.onchange = function (a) {
        this.colorRequire = false;
        this.colorcode = a;
    };
    OrderStatusAddComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-spurt-orderstatus-add',
            template: __webpack_require__(/*! ./add.component.html */ "./src/theme/default/admin/settings/components/localizations/orderstatus/add/add.component.html"),
            styles: ["\n  .settings-right-wrapper {\n    margin-top: 0px !important;\n}"]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"],
            _core_admin_settings_localizations_orderstatus_orderstatus_sandbox__WEBPACK_IMPORTED_MODULE_4__["OrderstatusSandbox"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
            _core_admin_settings_localizations_orderstatus_orderstatus_ApiClientService__WEBPACK_IMPORTED_MODULE_5__["OrderstatusApiClientService"]])
    ], OrderStatusAddComponent);
    return OrderStatusAddComponent;
}());
...
/***/ "./src/theme/default/admin/settings/components/localizations/orderstatus/list/list.component.html":
/*!********************************************************************************************************!*\
  !*** ./src/theme/default/admin/settings/components/localizations/orderstatus/list/list.component.html ***!
  \********************************************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"flex setting2-inner-header\">\n    <h3>Settings > Localization > Order Status</h3>\n    <button class=\"btn\" (click)=\"addorderstatus()\"><img\n            src=\"assets/img/add-white-ico.png\">Add OrderStatus\n    </button>\n</div>\n<div class=\"settings-right-wrapper\">\n\n    <div class=\"table-responsive\">\n        <table class=\"table\">\n            <thead>\n                <tr>\n                    <th>Order Status Name</th>\n                    <th>Status</th>\n                    <th>Action</th>\n                </tr>\n            </thead>\n            <tbody>\n                <tr *ngFor=\"let Orderstatuslist of Sandbox.getOrderstatuslist$ | async; let i=index\">\n\n\n                    <td><span style=\"padding:5px;background:#00b259;\" [ngStyle]=\"{'color':'white', 'background':Orderstatuslist.colorCode}\">\n                    </span> {{Orderstatuslist.name}}</td>\n                    <td>\n                        <div *ngIf=\"Orderstatuslist.isActive === 1\">Active</div>\n                        <div *ngIf=\"Orderstatuslist.isActive === 0\">In-Active</div>\n                    </td>\n\n                    <td><i (click)=\"editOrderStatusList(Orderstatuslist)\" class=\"fas fa-edit\"></i> <i [ngbPopover]=\"deleteContent\" placement=\"bottom\" #deletePop=\"ngbPopover\" style=\"margin-left: 15px;\" class=\"fas fa-trash\">\n                    <ng-template #deleteContent>\n                        <div class=\"style\">\n                            <div class=\"modal-header\">\n                                <h6 class=\"modal-title\" style=\"margin-left: 17%;\"> Do you want to delete ?</h6>\n\n                            </div>\n\n                            <div class=\"modal-footer\" style=\"margin-right: 23%;\">\n                                <button type=\"button\" class=\"btn btn-danger\" (click)=\"deletePop.close()\"\n                                        data-dismiss=\"modal\">No\n                                </button>\n                                <button type=\"button\" class=\"btn btn-success\"\n                                        (click)=\"deleteStockStatus(Orderstatuslist.orderStatusId, deletePop)\"\n                                        data-dismiss=\"modal\">Yes\n                                </button>\n                            </div>\n                        </div>\n                    </ng-template>\n\n                </i></td>\n\n                </tr>\n            </tbody>\n        </table>\n    </div>\n    <mat-paginator [length]=\"Sandbox.getOrderstatuspaginationcount$ | async\" [pageSize]=\"pageSize\" [pageSizeOptions]=\"[pageSize]\" (page)=\"onPageChange($event)\">\n    </mat-paginator>\n</div>"

/***/ }),

/***/ "./src/theme/default/admin/settings/components/localizations/orderstatus/list/list.component.ts":
/*!******************************************************************************************************!*\
  !*** ./src/theme/default/admin/settings/components/localizations/orderstatus/list/list.component.ts ***!
  \******************************************************************************************************/
...
/* harmony import */ var _core_admin_settings_localizations_orderstatus_orderstatus_ApiClientService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../../../../core/admin/settings/localizations/orderstatus/orderstatus-ApiClientService */ "./src/core/admin/settings/localizations/orderstatus/orderstatus-ApiClientService.ts");
...
var OrderStatusListComponent = /** @class */ (function () {
    function OrderStatusListComponent(router, Sandbox, service) {
        this.router = router;
    ...
    OrderStatusListComponent.prototype.ngOnInit = function () {
     ...
     * @param params storing entire value
     */
    OrderStatusListComponent.prototype.getorderstatuslist = function (offset, keyword) {
    ...
    OrderStatusListComponent.prototype.editOrderStatusList = function (orderstatusinfo) {
    ...
    OrderStatusListComponent.prototype.addorderstatus = function () {
        this.service.statusordersetdata('');
        this.router.navigate(['/settings/local/order-status/add']);
    };
    // Pagination Count
    OrderStatusListComponent.prototype.onPageChange = function (event) {
    ...
    OrderStatusListComponent.prototype.deleteStockStatus = function (orderStatusId, deletePop) {
        event.stopPropagation();
        this.popoverContent = deletePop;
        this.Sandbox.orderstatusDelete({ orderStatusId: orderStatusId });
    };
    // Delete After Subscribe the result
    OrderStatusListComponent.prototype.regSubscribeEvents = function () {
        var _this = this;
        this.Sandbox.getorderdelete$.subscribe(function (_delete) {
            if (_delete && _delete.status === 1) {
                _this.getorderstatuslist(_this.offset, _this.keyword);
            }
        });
    };
    OrderStatusListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-settings-orderstatus-list',
            template: __webpack_require__(/*! ./list.component.html */ "./src/theme/default/admin/settings/components/localizations/orderstatus/list/list.component.html"),
            styles: ["\n  .settings-right-wrapper {\n    margin-top: 0px !important;\n}"]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            ...
            _core_admin_settings_localizations_orderstatus_orderstatus_ApiClientService__WEBPACK_IMPORTED_MODULE_4__["OrderstatusApiClientService"]])
...
/***/ "./src/theme/default/admin/settings/components/localizations/orderstatus/orderstatus.module.ts":
/*!*****************************************************************************************************!*\
  !*** ./src/theme/default/admin/settings/components/localizations/orderstatus/orderstatus.module.ts ***!
  \*****************************************************************************************************/
...
/* harmony import */ var _add_add_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./add/add.component */ "./src/theme/default/admin/settings/components/localizations/orderstatus/add/add.component.ts");
/* harmony import */ var _list_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./list/list.component */ "./src/theme/default/admin/settings/components/localizations/orderstatus/list/list.component.ts");
/* harmony import */ var _orderstatus_routing__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./orderstatus.routing */ "./src/theme/default/admin/settings/components/localizations/orderstatus/orderstatus.routing.ts");
...
var OrderStatusModule = /** @class */ (function () {
    ...
    OrderStatusModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_add_add_component__WEBPACK_IMPORTED_MODULE_5__["OrderStatusAddComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_6__["OrderStatusListComponent"]],
            imports: [
                ...
                _orderstatus_routing__WEBPACK_IMPORTED_MODULE_7__["OrderStatusRoutingModule"],
...
/***/ "./src/theme/default/admin/settings/components/localizations/orderstatus/orderstatus.routing.ts":
/*!******************************************************************************************************!*\
  !*** ./src/theme/default/admin/settings/components/localizations/orderstatus/orderstatus.routing.ts ***!
  \******************************************************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _add_add_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add/add.component */ "./src/theme/default/admin/settings/components/localizations/orderstatus/add/add.component.ts");
/* harmony import */ var _list_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./list/list.component */ "./src/theme/default/admin/settings/components/localizations/orderstatus/list/list.component.ts");
...
var orderstatusRoutes = [
    // { path: '', redirectTo: 'list', pathMatch: 'full' },
    { path: '', component: _list_list_component__WEBPACK_IMPORTED_MODULE_4__["OrderStatusListComponent"] },
    { path: 'add', component: _add_add_component__WEBPACK_IMPORTED_MODULE_3__["OrderStatusAddComponent"] },
    {
        path: 'edit/:id',
        component: _add_add_component__WEBPACK_IMPORTED_MODULE_3__["OrderStatusAddComponent"]
    }
];
var OrderStatusRoutingModule = /** @class */ (function () {
    ...
    OrderStatusRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(orderstatusRoutes)],
...
//# sourceMappingURL=orderstatus-orderstatus-module.js.map