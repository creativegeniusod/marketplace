...
let ProductService = class ProductService {
    ...
    customProductList(limit, offset, categoryId = [], manufacturerId, condition, keyword, priceFrom, priceTo, price) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.productRepository.customProductList(limit, offset, categoryId, manufacturerId, condition, keyword, priceFrom, priceTo, price);
        });
    }
    // Product count
    productCount(keyword, manufacturerId, categoryId, priceFrom, priceTo) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.productRepository.productCount(keyword, manufacturerId, categoryId, priceFrom, priceTo);
        });
    }
};
